...
await Database().addProduct(title.text, dec.text, price.text, sqt.text, imagUrl);
                        Get.back();
                            },
                            child: Padding(
                              padding: const EdgeInsets.symmetric(
...
class AddNewItemsMobile extends StatelessWidget {
...
class AddNewItemsMain extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return (!isMobile(context)) ? AddNewItems() : AddNewItemsMobile();
  }
}
